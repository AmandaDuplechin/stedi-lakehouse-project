...
step_trainer_trusted_target_node1764027922914 = glueContext.getSink(path="s3://duplechin-d609-001/trusted-zone/step_trainer/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="step_trainer_trusted_target_node1764027922914")
step_trainer_trusted_target_node1764027922914.setCatalogInfo(catalogDatabase="stedi",catalogTableName="step_trainer_trusted")
step_trainer_trusted_target_node1764027922914.setFormat("glueparquet", compression="snappy")
step_trainer_trusted_target_node1764027922914.writeFrame(step_trainer_trusted_join_node1764027865276)
job.commit()